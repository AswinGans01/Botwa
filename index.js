...
/////////////////
const BotName = 'Dark Sky BOT☄'; 
const instagram = 'Aswin_id'; 
const telegram = 'Aswin Danendra'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Aswin_id')
